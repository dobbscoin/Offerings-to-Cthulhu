...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "checkpoints",        "getrollingcheckpoints",        &getrollingcheckpoints,        true,      false,      false },
    { "checkpoints",        "clearrollingcheckpoints",      &clearrollingcheckpoints,      true,      false,      false },
    { "checkpoints",        "setrollingcheckpointsenabled", &setrollingcheckpointsenabled, true,      false,      false },
    ...
    { "wallet",             "lockunspent",            &lockunspent,            false,     false,      true },
