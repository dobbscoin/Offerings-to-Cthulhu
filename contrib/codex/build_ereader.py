...
NAV_FALLBACK = """<nav class="sitenav">
  <span class="sitenav-row">
    ...
    <a class="btn" href="https://github.com/dobbscoin/Offerings-to-Cthulhu" target="_blank" rel="noopener">GITHUB SOURCE</a>
    <a class="btn" href="https://github.com/dobbscoin/Offerings-to-Cthulhu/releases/latest" target="_blank" rel="noopener">WALLETS</a>
  </span>
